...
bool RomBrowserStateMachine::FireDirect(RomBrowserStateTrigger trigger)
{
    ...
    if (StateMachineTriggerChecker(_curState, trigger)
        ...
        .In(RomBrowserState::Browser)
            ...
            .Trigger(RomBrowserStateTrigger::ShowThemeSettings).GoesTo(RomBrowserState::ThemeSettings)
            .Trigger(RomBrowserStateTrigger::ShowLanguageSettings).GoesTo(RomBrowserState::LanguageSettings)
        ...
        .In(RomBrowserState::ThemeSettings)
            .Trigger(RomBrowserStateTrigger::HideThemeSettings).GoesTo(RomBrowserState::Browser)
        .In(RomBrowserState::LanguageSettings)
            .Trigger(RomBrowserStateTrigger::HideLanguageSettings).GoesTo(RomBrowserState::Browser)
        .Check(newState))
    {
